...
const CategoryPage = ({ params }) => {
    ...
    const fetchCategoryData = async () => {
        ...
        try {
            const categoryResponse = await fetch(`https://strapi-app-tntk.onrender.com/api/product-categories?filters[slug][$eq]=${slug}`);
    ...
    const fetchProducts = async (categorySlug) => {
        ...
        try {
            // alert(categorySlug);
            const productResponse = await fetch(`https://strapi-app-tntk.onrender.com/api/products?filters[product_categories][slug][$eq]=${categorySlug}`);
