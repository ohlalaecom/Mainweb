...
const accountLinks = [
    { text: 'Account Information', url: '/account/user-information' },
    { text: 'Address', url: '/account/addresses' },
];

export default function AccountQuickLinksMobile() {
    const dispatch = useDispatch();
    ...
    const handleLogout = (e) => {
        ...
        if (confirm('Are you sure you want to logout?')) {
            ...
            dispatch(clearUser()); // Optional: only if you have this action
            dispatch(userChangeIsLoggedIn(false));
            router.push('/');
        }
    };
